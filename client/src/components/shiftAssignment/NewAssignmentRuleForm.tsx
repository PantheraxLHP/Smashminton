                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input
                                            placeholder="Quy tắc phân công mới"
                            ...
                            render={({ field }) => (
                                <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                                    ...
                                    <div className="space-y-1 leading-none">
                                        ...
                                        <FormDescription>Dùng để chỉnh trạng thái áp dụng của quy tắc mới thêm</FormDescription>
                                        <FormMessage />
                                    </div>
                                </FormItem>
                            )}
                                ...
                                <PopoverTrigger asChild>
                                    <FormControl>
                                        ...
                                        >
                                            {field.value
                                                ? ruleappliedfor.find(
                                                    (forobj) => forobj.value === field.value
                                                )?.label
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Input
                                    placeholder="ncte.comparecolumn"
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Input
                                    placeholder="comparecolumn < rulevalue"
