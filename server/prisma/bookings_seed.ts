...
async function main() {
        ...
        data: [
            {
                ...
                createdat: new Date('2025-08-14T09:22:19.422Z'),
                updatedat: new Date('2025-08-14T09:22:19.422Z'),
                employeeid: 3,
                customerid: 16,
                voucherid: null,
            },
            ...
            {
                guestphone: '0987654321',
                bookingdate: new Date('2025-08-16'),
                totalprice: 500000.0,
                bookingstatus: 'confirmed',
                createdat: new Date('2025-08-14T11:00:00.000Z'),
                updatedat: new Date('2025-08-14T11:00:00.000Z'),
                employeeid: 1,
                customerid: 16,
                voucherid: null,
            },
    ...
    await prisma.court_booking.createMany({
        data: [
            ...
            { date: new Date('2025-08-15'), starttime: new Date('2025-08-15 06:00:00'), endtime: new Date('2025-08-15 07:00:00'), duration: 1, bookingid: bookings[0].bookingid, courtid: 1 },
            { date: new Date('2025-08-15'), starttime: new Date('2025-08-15 06:00:00'), endtime: new Date('2025-08-15 07:30:00'), duration: 1.5, bookingid: bookings[0].bookingid, courtid: 2 },
            { date: new Date('2025-08-15'), starttime: new Date('2025-08-15 06:00:00'), endtime: new Date('2025-08-15 08:00:00'), duration: 2, bookingid: bookings[0].bookingid, courtid: 3 },
            { date: new Date('2025-08-15'), starttime: new Date('2025-08-15 06:00:00'), endtime: new Date('2025-08-15 08:30:00'), duration: 2.5, bookingid: bookings[0].bookingid, courtid: 4 },
            { date: new Date('2025-08-15'), starttime: new Date('2025-08-15 06:00:00'), endtime: new Date('2025-08-15 09:00:00'), duration: 3, bookingid: bookings[0].bookingid, courtid: 5 },
            ...
            { date: new Date('2025-08-15'), starttime: new Date('2025-08-15 13:30:00'), endtime: new Date('2025-08-15 15:30:00'), duration: 2, bookingid: bookings[1].bookingid, courtid: 2 },

            // Trường hợp 4: Khung giờ không liên quan đến ngày được kiểm tra
            { date: new Date('2025-08-16'), starttime: new Date('2025-08-16 06:00:00'), endtime: new Date('2025-08-16 07:00:00'), duration: 1, bookingid: bookings[2].bookingid, courtid: 1 },
        ],
    });
